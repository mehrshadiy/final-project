                ...
                <div className="mb-[68px]">
                    <div
                        ...
                        <ImageView src={"/assets/images/Screenshot (76).png"}
                                   classname={"absolute bottom-0 right-0 sm:h-full h-3/4"} alt={"banner"} height={587}
                                   width={331}/>
                    </div>
                </div>
                <div
                    ...
                    <div className="max-w-[346px]">
                        ...
                        <div className="flex items-start gap-2.5 mt-4 lg:mt-6">
                            ...
                            <div className="font-lato text-medium text-blue-300"><span
                                className="font-bold">Address:</span> 5171 W Campbell Ave undefined Kent, Utah 53127
                                United States
                            </div>
                        </div>
                    ...
                    <div className="pt-4 md:pt-0">
                        <div
                            className="text-heading6 md:text-heading5 lg:text-heading4 xl:text-heading4 text-blue-300">
                            App & Payment
                        </div>
                        ...
                        <div className="flex items-center gap-6 justify-center xl:justify-start pt-4 lg:pt-5">
                            <Link href="#">
                                <ImageView src={"/assets/images/va724oeh 1.png"} alt={"Download app from apple store"}
                                           width={129} height={39}/>
                            </Link>
                            <Link href="#">
                                <ImageView src={"/assets/images/17kw6njp 1.png"} alt={"Download app from google play"}
                                           width={129} height={39}/>
                            </Link>
                        </div>
                        <div
                            className="font-lato text-small text-blue-300 text-center lg:text-left pt-4 lg:pt-5">
