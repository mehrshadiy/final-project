        ...
        <>
                <div
                    ...
                    <div className="pl-[20px] md:pl-[60px]">
                        <h2 className="text-heading5 sm:text-heading4 lg:text-heading2 xl:text-heading1 2xl:text-display2 text-blue-300 mb-[33px]">Don’t
                            {title}</h2>
                        <p className="text-gray-500 mb-[68px] hidden md:inline-block">
                            {subtitle}
                        </p>
